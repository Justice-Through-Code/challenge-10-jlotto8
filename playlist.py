...
# '''
add_song(my_playlist,{"artist": "Lawrence", "title": "Dont Lose Sight"})
...
add_song(my_playlist, {"artist": "Bob Dylan", "title": "Idiot Wind"})
add_song(my_playlist, {"artist": "Leonard Cohen", "title": "Famous Blue Raincoat"})
...
average = round(np.mean(monthly_plays))
print(average)
